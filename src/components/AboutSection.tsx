          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="premium-card p-4 text-center bg-white/10" data-aos="zoom-in" data-aos-delay="0">
                  <div className="font-playfair text-2xl font-bold text-secondary mb-1">1957</div>
                  <div className="font-crimson text-lg text-white/80">Legacy Since</div>
                </div>
                <div className="premium-card p-4 text-center bg-white/10" data-aos="zoom-in" data-aos-delay="100">
                  <div className="font-playfair text-2xl font-bold text-secondary mb-1">1000+</div>
                  <div className="font-crimson text-lg text-white/80">Families Served</div>
                </div>
              </div>
            </div>
            <div>
