                ...
                <div className="pb-4 bg-gradient-to-r from-background to-champagne/20 px-8 pt-6">
                    <div className="flex items-center gap-3">
                        <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-champagne/50">
                            <span className="text-2xl text-accent">{displayIcon}</span>
                        </span>
                        <div>
                            {title && <h2 className="font-playfair text-2xl font-bold bg-gradient-to-r from-accent to-secondary bg-clip-text text-transparent">{title}</h2>}
