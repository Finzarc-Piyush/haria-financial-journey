...
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({ value, label, progress, chartType = 'bar' }) => {
    ...
    return (
        <div className={`w-full flex flex-col items-center justify-center mb-6 transform transition-all duration-700 ${visible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            ...
            <div className="font-playfair text-4xl md:text-5xl text-secondary font-bold mb-2 animate-countup">
