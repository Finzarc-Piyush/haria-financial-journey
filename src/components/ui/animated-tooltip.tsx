      ...
      {items.map((item) => (
        ...
        >
          ...
          <img
            ...
            src={item.image}
            alt={item.name}
            className="object-cover !m-0 !p-0 object-top rounded-full h-20 w-20 md:h-24 md:w-24 border-4 group-hover:scale-105 group-hover:z-30 border-secondary relative transition duration-500 cursor-pointer"
          />
        </div>
      ))}
    </div>
